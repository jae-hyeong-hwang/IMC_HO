...
#ifndef IMC_OPTICALBACKSCATTER_HPP_INCLUDED_
#define IMC_OPTICALBACKSCATTER_HPP_INCLUDED_
...
namespace IMC
{
  ...
  public:
    ...
    cast(Message* msg__)
    {
      return (OpticalBackscatter*)msg__;
    }

    OpticalBackscatter(void)
    {
      m_header.mgid = OpticalBackscatter::getIdStatic();
      clear();
    }
