...
#ifndef IMC_DESIREDHEADINGRATE_HPP_INCLUDED_
#define IMC_DESIREDHEADINGRATE_HPP_INCLUDED_
...
namespace IMC
{
  ...
  public:
    ...
    cast(Message* msg__)
    {
      return (DesiredHeadingRate*)msg__;
    }

    DesiredHeadingRate(void)
    {
      m_header.mgid = DesiredHeadingRate::getIdStatic();
      clear();
    }
