...
#ifndef IMC_TOTALMAGINTENSITY_HPP_INCLUDED_
#define IMC_TOTALMAGINTENSITY_HPP_INCLUDED_
...
namespace IMC
{
  ...
  public:
    ...
    static TotalMagIntensity*
    cast(Message* msg__)
    {
      return (TotalMagIntensity*)msg__;
    }

    TotalMagIntensity(void)
    {
      m_header.mgid = TotalMagIntensity::getIdStatic();
      clear();
    }
