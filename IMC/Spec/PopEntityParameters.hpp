...
#ifndef IMC_POPENTITYPARAMETERS_HPP_INCLUDED_
#define IMC_POPENTITYPARAMETERS_HPP_INCLUDED_
...
namespace IMC
{
  ...
  public:
    ...
    cast(Message* msg__)
    {
      return (PopEntityParameters*)msg__;
    }

    PopEntityParameters(void)
    {
      m_header.mgid = PopEntityParameters::getIdStatic();
      clear();
    }
