...
#ifndef IMC_GETOPERATIONALLIMITS_HPP_INCLUDED_
#define IMC_GETOPERATIONALLIMITS_HPP_INCLUDED_
...
namespace IMC
{
  ...
  public:
    ...
    cast(Message* msg__)
    {
      return (GetOperationalLimits*)msg__;
    }

    GetOperationalLimits(void)
    {
      m_header.mgid = GetOperationalLimits::getIdStatic();
      clear();
    }
