...
#ifndef IMC_DESIREDVERTICALRATE_HPP_INCLUDED_
#define IMC_DESIREDVERTICALRATE_HPP_INCLUDED_
...
namespace IMC
{
  ...
  public:
    ...
    cast(Message* msg__)
    {
      return (DesiredVerticalRate*)msg__;
    }

    DesiredVerticalRate(void)
    {
      m_header.mgid = DesiredVerticalRate::getIdStatic();
      clear();
    }
