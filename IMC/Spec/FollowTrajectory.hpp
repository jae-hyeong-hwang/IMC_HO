...
#ifndef IMC_FOLLOWTRAJECTORY_HPP_INCLUDED_
#define IMC_FOLLOWTRAJECTORY_HPP_INCLUDED_
...
namespace IMC
{
  ...
  public:
    ...
    cast(Message* msg__)
    {
      return (FollowTrajectory*)msg__;
    }

    FollowTrajectory(void)
    {
      m_header.mgid = FollowTrajectory::getIdStatic();
      clear();
