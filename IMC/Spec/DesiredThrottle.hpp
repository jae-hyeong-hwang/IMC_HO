...
#ifndef IMC_DESIREDTHROTTLE_HPP_INCLUDED_
#define IMC_DESIREDTHROTTLE_HPP_INCLUDED_
...
namespace IMC
{
  ...
  public:
    ...
    cast(Message* msg__)
    {
      return (DesiredThrottle*)msg__;
    }

    DesiredThrottle(void)
    {
      m_header.mgid = DesiredThrottle::getIdStatic();
      clear();
    }
    ...
    {
      const IMC::DesiredThrottle& other__ = static_cast<const DesiredThrottle&>(msg__);
