...
#ifndef IMC_RELATIVEHUMIDITY_HPP_INCLUDED_
#define IMC_RELATIVEHUMIDITY_HPP_INCLUDED_
...
namespace IMC
{
  ...
  public:
    ...
    cast(Message* msg__)
    {
      return (RelativeHumidity*)msg__;
    }

    RelativeHumidity(void)
    {
      m_header.mgid = RelativeHumidity::getIdStatic();
      clear();
    }
