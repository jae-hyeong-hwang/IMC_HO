...
#ifndef IMC_SMSSTATUS_HPP_INCLUDED_
#define IMC_SMSSTATUS_HPP_INCLUDED_
...
namespace IMC
{
  ...
  public:
    ...
    cast(Message* msg__)
    {
      return (SmsStatus*)msg__;
    }

    SmsStatus(void)
    {
      m_header.mgid = SmsStatus::getIdStatic();
      clear();
    }
    ...
    {
      const IMC::SmsStatus& other__ = static_cast<const SmsStatus&>(msg__);
