...
#ifndef IMC_QUERYLEDBRIGHTNESS_HPP_INCLUDED_
#define IMC_QUERYLEDBRIGHTNESS_HPP_INCLUDED_
...
namespace IMC
{
  ...
  public:
    ...
    cast(Message* msg__)
    {
      return (QueryLedBrightness*)msg__;
    }

    QueryLedBrightness(void)
    {
      m_header.mgid = QueryLedBrightness::getIdStatic();
      clear();
    }
