...
#ifndef IMC_TELEOPERATIONDONE_HPP_INCLUDED_
#define IMC_TELEOPERATIONDONE_HPP_INCLUDED_
...
namespace IMC
{
  ...
  public:
    ...
    cast(Message* msg__)
    {
      return (TeleoperationDone*)msg__;
    }

    TeleoperationDone(void)
    {
      m_header.mgid = TeleoperationDone::getIdStatic();
      clear();
    }
