...
#ifndef IMC_SESSIONKEEPALIVE_HPP_INCLUDED_
#define IMC_SESSIONKEEPALIVE_HPP_INCLUDED_
...
namespace IMC
{
  ...
  public:
    ...
    cast(Message* msg__)
    {
      return (SessionKeepAlive*)msg__;
    }

    SessionKeepAlive(void)
    {
      m_header.mgid = SessionKeepAlive::getIdStatic();
      clear();
    }
