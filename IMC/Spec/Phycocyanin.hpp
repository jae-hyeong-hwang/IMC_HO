...
#ifndef IMC_PHYCOCYANIN_HPP_INCLUDED_
#define IMC_PHYCOCYANIN_HPP_INCLUDED_
...
namespace IMC
{
  ...
  public:
    ...
    cast(Message* msg__)
    {
      return (Phycocyanin*)msg__;
    }

    Phycocyanin(void)
    {
      m_header.mgid = Phycocyanin::getIdStatic();
      clear();
    }
    ...
    {
      const IMC::Phycocyanin& other__ = static_cast<const Phycocyanin&>(msg__);
