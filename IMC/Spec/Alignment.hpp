...
#ifndef IMC_ALIGNMENT_HPP_INCLUDED_
#define IMC_ALIGNMENT_HPP_INCLUDED_
...
namespace IMC
{
  ...
  public:
    ...
    cast(Message* msg__)
    {
      return (Alignment*)msg__;
    }

    Alignment(void)
    {
      m_header.mgid = Alignment::getIdStatic();
      clear();
    }
    ...
    {
      const IMC::Alignment& other__ = static_cast<const Alignment&>(msg__);
