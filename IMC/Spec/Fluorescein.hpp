...
#ifndef IMC_FLUORESCEIN_HPP_INCLUDED_
#define IMC_FLUORESCEIN_HPP_INCLUDED_
...
namespace IMC
{
  ...
  public:
    ...
    cast(Message* msg__)
    {
      return (Fluorescein*)msg__;
    }

    Fluorescein(void)
    {
      m_header.mgid = Fluorescein::getIdStatic();
      clear();
    }
    ...
    {
      const IMC::Fluorescein& other__ = static_cast<const Fluorescein&>(msg__);
